...
class MainApp(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        #init sliders
        val_pb = self.ui.sliderPB.value()
        self.ui.lab_PB.setText(str(val_pb))
        val_pa = self.ui.sliderPB.value()
        self.ui.lab_PA.setText(str(val_pa))
        val_nt = self.ui.sliderPB.value()
        self.ui.lab_NT.setText(str(val_nt))
        ...
        self.ui.sliderPB.sliderReleased.connect(lambda: self.set_flag("filter_now"))
        self.ui.sliderPA.sliderReleased.connect(lambda: self.set_flag("filter_now"))
        self.ui.sliderNT.sliderReleased.connect(lambda: self.set_flag("filter_now"))
        # Botões
        self.ui.actionOriginal_Sound.triggered.connect(lambda: self.set_flag("save_now"))
        self.ui.actionOpen.triggered.connect(lambda: self.set_flag("open_now"))

        self.ui.recButton.clicked.connect(lambda: self.set_flag ("rec_now"))
        self.ui.playButton.clicked.connect(lambda: self.set_flag ("play_now"))
        self.ui.stopButton.clicked.connect(lambda: self.set_flag("wait_now"))
        self.ui.pauseButton.clicked.connect(lambda: self.set_flag("pause_now"))
        self.ui.clearButton.clicked.connect(lambda: self.set_flag("clear_now"))
        
        self.ui.exitButton.clicked.connect(lambda: self.exit())
        self.ui.freqtime_toggButon.clicked.connect(lambda: self.switch_freq_time())
        self.ui.refreshButton.clicked.connect(lambda: self.refresh_adv_pars())
        self.ui.adv_pars_Buton.clicked.connect(lambda: self.hide_show_adv_menu())
...
##########################################################
    ...
    def filtrar(self):
        try:
            fc_PB = self.ui.sliderPB.value()
            fc_PA = self.ui.sliderPA.value()
            fc_NT = self.ui.sliderNT.value()
